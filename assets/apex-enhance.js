...
(function () {
 ...
 var CSS = [
   ...
   ".apex-header-ig{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:50%;color:#c0c8e0;background:transparent;border:1px solid transparent;transition:color .15s,border-color .15s;margin-right:6px;}",
   ".apex-header-ig:hover,.apex-header-ig:focus-visible{color:#4a8ff5;border-color:#2e3c54;outline:none;}",
   ".apex-contact-links{display:flex;flex-direction:column;gap:10px;margin-bottom:22px;}",
   ".apex-contact-link{display:inline-flex;align-items:center;gap:8px;color:#c0c8e0;text-decoration:none;font-size:14px;transition:color .15s;}",
   ".apex-contact-link:hover,.apex-contact-link:focus-visible{color:#4a8ff5;outline:none;}",
   ".apex-follow{background:#05070c;padding:64px 16px;border-top:1px solid #1e2a3a;text-align:center;}",
   ...
   ".apex-follow-inner p{color:#9aa3b8;font-size:14px;margin-bottom:26px;}",
   ...
   ".apex-follow-btn:focus-visible{outline:2px solid #4a8ff5;outline-offset:2px;}",
   ".apex-follow-btn.ig{background:linear-gradient(135deg,#4a8ff5,#8b5cf6);color:#fff;}",
