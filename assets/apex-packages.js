...
(function () {
  ...
  var STYLE = [
    ...
    "#apex-pkgs .pkg-card { background: #ffffff; border: 1px solid #e2e7eb; border-radius: 14px; overflow: hidden; display: flex; flex-direction: column; transition: transform .2s, border-color .2s, box-shadow .2s; }",
